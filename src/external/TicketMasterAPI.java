...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "AQpXYJW9AJ6TAg5RinXdtsDCqiyh9UE7";
	...
	private String getAddress(JSONObject event)throws JSONException{
		if(!event.isNull("_embedded")) {
			JSONObject embeddedJsonObject = event.getJSONObject("_embedded");
			if(!embeddedJsonObject.isNull("venues")) {
				JSONArray venues = embeddedJsonObject.getJSONArray("venues");
